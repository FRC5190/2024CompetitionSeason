...
public class Climber extends SubsystemBase {
    ...
    public Climber() {
        ...
        left_leader_.setIdleMode(CANSparkMax.IdleMode.kBrake);
        ...
        right_leader_.setIdleMode(CANSparkMax.IdleMode.kBrake);
    ...
    public static class PeriodicIO {
        ...
        // Motor Controllers
        public static final int kLeftLeaderId = 16;
        public static final int kRightLeaderId = 17;
