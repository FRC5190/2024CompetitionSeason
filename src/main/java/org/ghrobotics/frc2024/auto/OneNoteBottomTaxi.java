...
public class OneNoteBottomTaxi extends SequentialCommandGroup {
  PathPlannerPath pickup_bottom = PathPlannerPath.fromPathFile("Pickup Bottom");
  public OneNoteBottomTaxi(Drive drive, Superstructure superstructure) {
    Command pickupBottom = AutoBuilder.followPath(pickup_bottom);

    addCommands(
      superstructure.setArmPID(-70),
